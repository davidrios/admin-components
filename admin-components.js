(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("Immutable"), require("React.addons.PureRenderMixin"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "Immutable", "React.addons.PureRenderMixin"], factory);
	else if(typeof exports === 'object')
		exports["admin-components"] = factory(require("react"), require("Immutable"), require("React.addons.PureRenderMixin"));
	else
		root["admin-components"] = factory(root["React"], root["Immutable"], root["React.addons.PureRenderMixin"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tagsInput = __webpack_require__(43);

	var _tagsInput2 = _interopRequireDefault(_tagsInput);

	var _modifiersInput = __webpack_require__(58);

	var _modifiersInput2 = _interopRequireDefault(_modifiersInput);

	var _selectInput = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AutocompletedBaseTextInput = exports.BaseTextInput = undefined;
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(22);

	var _reactAddonsPureRenderMixin2 = _interopRequireDefault(_reactAddonsPureRenderMixin);

	var _autocompleted = __webpack_require__(57);

	var _autocompleted2 = _interopRequireDefault(_autocompleted);
	...
	var AutocompletedBaseTextInput = exports.AutocompletedBaseTextInput = function (_React$Component2) {
	  (0, _inherits3.default)(AutocompletedBaseTextInput, _React$Component2);

	  function AutocompletedBaseTextInput() {
	    (0, _classCallCheck3.default)(this, AutocompletedBaseTextInput);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(AutocompletedBaseTextInput).apply(this, arguments));
	  }

	  (0, _createClass3.default)(AutocompletedBaseTextInput, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        _autocompleted2.default,
	        this.props.autocomplete.toObject(),
	        _react2.default.createElement(BaseTextInput, (0, _utils.makePropsSubset)(this.props, BaseTextInput.propTypes))
	      );
	    }
	  }]);
	  return AutocompletedBaseTextInput;
	}(_react2.default.Component);
	...
	AutocompletedBaseTextInput.propTypes = {
	  autocomplete: _react2.default.PropTypes.instanceOf(_immutable2.default.Map)
	};

	var TextInput = function (_React$Component3) {
	  (0, _inherits3.default)(TextInput, _React$Component3);
	  ...
	  (0, _createClass3.default)(TextInput, [{
	    key: 'render',
	    value: function render() {
	      var InputClass = this.props.autocomplete != null ? AutocompletedBaseTextInput : BaseTextInput;

	      return _react2.default.createElement(
	        _base2.default,
	        (0, _utils.makePropsSubset)(this.props, _base2.default.propTypes),
	        _react2.default.createElement(InputClass, (0, _extends3.default)({}, (0, _utils.makePropsSubset)(this.props, BaseTextInput.propTypes), {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autocompleted = function (_React$Component) {
	  (0, _inherits3.default)(Autocompleted, _React$Component);

	  function Autocompleted(props) {
	    (0, _classCallCheck3.default)(this, Autocompleted);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Autocompleted).call(this, props));
	  ...
	  (0, _createClass3.default)(Autocompleted, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var _this2 = this;
	      ...
	      this.handleKeyboard = function (ev) {
	        ...
	        if (ev.type === 'keypress' && ev.code === 'Enter' && _this2.state.itemHighlighted != null) {
	          ev.preventDefault();
	          _this2.handleListClick(_this2.props.searchResults.get(_this2.state.itemHighlighted));
	          return;
	        }
	        ...
	        if (ev.type === 'keydown') {
	          if (ev.code === 'ArrowUp') {
	            if (!_this2.props.searchResults.size) {
	              return;
	            }

	            ev.preventDefault();

	            var itemHighlighted = _this2.state.itemHighlighted;

	            if (itemHighlighted == null) {
	              itemHighlighted = _this2.props.searchResults.size - 1;
	            } else {
	              itemHighlighted--;
	            ...
	            _this2.setState({ itemHighlighted: itemHighlighted });
	            ...
	            var _itemHighlighted = _this2.state.itemHighlighted;

	            if (_itemHighlighted == null) {
	              _itemHighlighted = 0;
	            } else {
	              _itemHighlighted++;

	              if (_itemHighlighted >= _this2.props.searchResults.size) {
	                _itemHighlighted = 0;
	              }
	            }

	            _this2.setState({ itemHighlighted: _itemHighlighted });
	          }
	        }
	      };
	    ...
	    value: function render() {
	      ...
	      var searchResultsElements = this.props.searchResults.map(function (val, index) {
	        return _react2.default.createElement(
	          'li',
	          { key: index,
	            className: (val.get('className') || '') + (_this3.state.itemHighlighted === index ? ' focus' : ''),
	            onClick: function onClick() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { className: 'autocomplete' + (!this.props.desktopSearch ? ' no-desktop-search' : '') },
	          _react2.default.createElement(
	            'li',
	            null,
	...
	Autocompleted.propTypes = {
	  ...
	  itemHighlighted: _react2.default.PropTypes.number,
	  ...
	  className: _react2.default.PropTypes.string,
	  desktopSearch: _react2.default.PropTypes.bool,
	...
	var BaseSearchableSelectInput = exports.BaseSearchableSelectInput = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(BaseSearchableSelectInput, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.handleDocumentClick = function (ev) {
	        if (ev.target !== _this2.mainDivRef && ev.target !== _this2.selectedSpanRef && ev.target !== _this2.searchValueRef.inputRef) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          { ref: function ref(el) {
	              return _this3.selectedSpanRef = el;
	            } },
